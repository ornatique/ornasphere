...
<head>
    ...
    <style>
        ...
        /* Keep W + QR + code visible in compact/double barcode preview */
        .label:not(.double-details) .left-col,
        .label:not(.double-details) .right-col {
            gap: 0.2mm;
        }

        .label:not(.double-details) .code {
            font-size: 6.6px;
            line-height: 1.05;
        }

        .label:not(.double-details) .qr {
            width: 6.5mm;
            height: 6.5mm;
        }
