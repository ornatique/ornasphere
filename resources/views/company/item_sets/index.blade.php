                ...
                <div class="row">
                    <div class="col-md-7 mb-3">
                        <div class="item-grid-image-preview-wrap">
                            ...
                            <div id="grid_image_crop_box" class="image-crop-box">
                    ...
                    <div class="col-md-5 mb-3">
                        ...
                        <div class="image-edit-tools border rounded p-2 mb-3" id="grid_image_edit_tools">
                            <div class="d-flex flex-wrap gap-2">
                                <button class="btn btn-sm btn-warning" id="gridCropBtn" type="button"><i class="mdi mdi-crop"></i> Crop</button>
                                <button class="btn btn-sm btn-info" id="gridRotateLeftBtn" type="button"><i class="mdi mdi-rotate-left"></i> Rotate Left</button>
                                <button class="btn btn-sm btn-info" id="gridRotateRightBtn" type="button"><i class="mdi mdi-rotate-right"></i> Rotate Right</button>
                                <button class="btn btn-sm btn-secondary" id="gridResetCropBtn" type="button"><i class="mdi mdi-crop-free"></i> Reset Crop</button>
                            </div>
...
<script>
    ...
    function createImageEditor(options) {
        ...
        function renderPreview() {
            ...
            return new Promise(function(resolve) {
                canvas.toBlob(function(blob) {
                    ...
                    setGridImagePreview(state.previewUrl);
                    resetCrop();
                    resolve(file);
                }, 'image/jpeg', 0.92);
            });
        ...
        function load(file) {
            ...
            img.onerror = function() {
                URL.revokeObjectURL(imageUrl);
                reset();
                $('#grid_image_upload_error').removeClass('d-none').text('Unable to read selected image.');
            };
            img.src = imageUrl;
        }
    ...
    const gridImageEditor = createImageEditor({
        tools: '#grid_image_edit_tools',
        wrap: '.item-grid-image-preview-wrap',
        preview: '#grid_item_image_preview',
        cropBox: '#grid_image_crop_box',
        crop: '#gridCropBtn',
        resetCrop: '#gridResetCropBtn',
        rotateLeft: '#gridRotateLeftBtn',
        rotateRight: '#gridRotateRightBtn'
    });
    ...
    $('#grid_item_image_file').on('change', function() {
        ...
        gridImageEditor.load(file);
    });

    $('#gridUploadImageBtn').on('click', async function() {
        resetGridImageMessages();
        ...
        const uploadFile = await gridImageEditor.getFile();
