...
<head>
    ...
    <style>
        ...
        .summary { margin: 0 0 7px; }
        .summary th { background: #22243a; color: #fff; text-align: left; }
...
<body>
    ...
    <table class="summary">
        <tr>
            ...
            <th>Total Other Wt</th>
            <th>Total Net Wt</th>
        </tr>
        <tr>
            <td>{{ (int)($summary['qty_pcs'] ?? 0) }}</td>
            <td>{{ number_format((float)($summary['gross_weight'] ?? 0), 3, '.', '') }}</td>
            <td>{{ number_format((float)($summary['other_weight'] ?? 0), 3, '.', '') }}</td>
            <td>{{ number_format((float)($summary['net_weight'] ?? 0), 3, '.', '') }}</td>
        </tr>
    </table>
    <table>
        <thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ number_format((float)($r->other_weight ?? 0), 3, '.', '') }}</td>
