                                    ...
                                    <div class="col-sm-9">
                                        <select name="category_person_id" class="form-control searchable-person-select @error('category_person_id') is-invalid @enderror">
                                            ...
                                            @foreach($categoryPeople as $categoryPerson)
                                                <option value="{{ $categoryPerson->id }}" {{ (string) old('category_person_id', $customer->category_person_id) === (string) $categoryPerson->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9"><input type="text" id="city" name="city" value="{{ old('city', $customer->city) }}" class="form-control"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9"><input type="text" id="area" name="area" value="{{ old('area', $customer->area) }}" class="form-control"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Landmark</label>
                                    <div class="col-sm-9"><input type="text" id="landmark" name="landmark" value="{{ old('landmark', $customer->landmark) }}" class="form-control"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9"><input type="text" id="pincode" name="pincode" value="{{ old('pincode', $customer->pincode) }}" class="form-control"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Address</label>
                                    <div class="col-sm-9"><textarea id="address" name="address" class="form-control">{{ old('address', $customer->address) }}</textarea></div>
                                </div>
                            </div>
                        </div>
