                ...
                <table class="table table-bordered table-striped" id="castingReleaseTable">
                    <thead>
                        <tr>
                            ...
                            <th>Release Tree Wt</th>
                            <th>Release Tree Bhuko</th>
                            <th>Loss</th>
                            <th>Pending</th>
                            <th>Action</th>
                        </tr>
...
<script>
    ...
    const castingReleaseTable = $('#castingReleaseTable').DataTable({
        ...
        columns: [
            ...
            { data: 'release_tree_wt_view', name: 'release_tree_wt_total', orderable: false, searchable: false },
            { data: 'release_tree_bhuko_view', name: 'release_tree_bhuko_total', orderable: false, searchable: false },
