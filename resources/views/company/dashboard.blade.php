...
@section('content')
   ...
   <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-6">
              <h3 class="mb-0 fw-bold">Kenneth Osborne</h3>
            ...
            <div class="col-sm-6">
              <div class="d-flex align-items-center justify-content-md-end">
                ...
                <div class="pr-1 mb-3 me-2 mb-xl-0">
                  <button type="button" class="btn btn-sm btn-dark btn-icon-text border"><i class="typcn typcn-arrow-forward-outline me-2"></i>Export</button>
                </div>
                <div class="pr-1 mb-3 mb-xl-0">
                  <button type="button" class="btn btn-sm btn-dark btn-icon-text border"><i class="typcn typcn-info-large-outline me-2"></i>info</button>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
                        <div class="col-lg-6">
                          <div id="circleProgress7" class="progressbar-js-circle rounded p-3"></div>
                        </div>
                        <div class="col-lg-6">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="d-flex justify-content-between mb-4">
                            <div class="fw-medium">Empolyee Name</div>
                            <div class="fw-medium">This Month</div>
                          </div>
                          <div class="d-flex justify-content-between mb-4">
                            <div class="text-secondary fw-medium">Connor Chandler</div>
                            <div class="small">$ 4909</div>
                          </div>
                          <div class="d-flex justify-content-between mb-4">
                            <div class="text-secondary fw-medium">Russell Floyd</div>
                            <div class="small">$857</div>
                          </div>
                          <div class="d-flex justify-content-between mb-4">
                            <div class="text-secondary fw-medium">Douglas White</div>
                            <div class="small">$612 </div>
                          </div>
                          <div class="d-flex justify-content-between mb-4">
                            <div class="text-secondary fw-medium">Alta Fletcher </div>
                            <div class="small">$233</div>
                          </div>
                          <div class="d-flex justify-content-between mb-4">
                            <div class="text-secondary fw-medium">Marguerite Pearson</div>
                            <div class="small">$233</div>
                          </div>
                          <div class="d-flex justify-content-between mb-4">
                            <div class="text-secondary fw-medium">Leonard Gutierrez</div>
                            <div class="small">$35</div>
                          </div>
                          <div class="d-flex justify-content-between mb-4">
                            <div class="text-secondary fw-medium">Helen Benson</div>
                    ...
                    <div class="col-12">
                      <div class="d-md-flex mb-4">
                        <div class="me-md-5 mb-4">
                          ...
                          <h2 class="text-primary mb-1 fw-bold">23,342</h2>
                        </div>
                        <div class="me-md-5 mb-4">
                          <h5 class="mb-1"><i class="typcn typcn-archive me-1"></i>Offline</h5>
                          <h2 class="text-secondary mb-1 fw-bold">13,221</h2>
                        </div>
                        <div class="me-md-5 mb-4">
                          <h5 class="mb-1"><i class="typcn typcn-tags me-1"></i>Marketing</h5>
                          <h2 class="text-warning mb-1 fw-bold">1,542</h2>
                        </div>
                      </div>
                    ...
                    <div class="col-12">
                      <div class="mb-5">
                        <div class="me-1">
                          ...
                          <h2 class="mb-2 mt-2 fw-bold">287,493$</h2>
                          <div class="fw-bold">
                        ...
                        <div class="me-1">
                          ...
                          <h2 class="mb-2 mt-2  fw-bold">87,493</h2>
                          <div class="fw-bold">
                            5.43% Since Last Month
                          </div>
                        </div>
                      </div>
                      <canvas id="barChartStackedDark"></canvas>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row">
                    <div class="col-lg-9">
                      ...
                      <div class="chart-container mt-4">
                        <canvas id="ecommerceAnalyticDark"></canvas>
                      </div>
                    </div>
                    <div class="col-lg-3">
                      <div>
                        <div class="d-flex justify-content-between mb-3">
                          <div class="text-success fw-bold">Inbound</div>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                          <div class="fw-medium">Current</div>
                          <div class="text-muted">38.34M</div>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                          <div class="fw-medium">Average</div>
                          <div class="text-muted">38.34M</div>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                          <div class="fw-medium">Maximum</div>
                          <div class="text-muted">68.14M</div>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                          <div class="fw-medium">60th %</div>
                          <div class="text-muted">168.3GB</div>
                        </div>
                      </div>
                      <hr>
                      <div class="mt-4">
                        <div class="d-flex justify-content-between mb-3">
                          <div class="text-success fw-bold">Outbound</div>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                          <div class="fw-medium">Current</div>
                    ...
                    <table class="table">
                      <tbody>
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="img-sm rounded-circle mb-md-0 me-2" src="../assets/images/faces/face30.png" alt="profile image">
                              <div>
                                <div> Company</div>
                                <div class="fw-bold mt-1 text-muted">volkswagen</div>
                              </div>
                            </div>
                          </td>
                          <td>
                            Budget
                            <div class="fw-bold  mt-1 text-muted">$2322 </div>
                          </td>
                          <td>
                            Status
                          ...
                          <td>
                            Deadline
                            <div class="fw-bold  mt-1 text-muted">07 Nov 2019</div>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="img-sm rounded-circle mb-md-0 me-2" src="../assets/images/faces/face31.png" alt="profile image">
                              <div>
                                <div> Company</div>
                                <div class="fw-bold  mt-1 text-muted">Land Rover</div>
                              </div>
                            </div>
                          </td>
                          <td>
                            Budget
                            <div class="fw-bold mt-1 text-muted">$12022 </div>
                          </td>
                          <td>
                            Status
                            <div class="fw-bold text-success  mt-1">70% </div>
                          </td>
                          <td>
                            Deadline
                            <div class="fw-bold mt-1 text-muted">08 Nov 2019</div>
                          </td>
                          <td>
                            <button type="button" class="btn btn-sm btn-dark border">edit actions</button>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="img-sm rounded-circle mb-md-0 me-2" src="../assets/images/faces/face32.png" alt="profile image">
                              <div>
                                <div> Company</div>
                                <div class="fw-bold mt-1 text-muted">Bentley </div>
                              </div>
                            </div>
                          </td>
                          <td>
                            Budget
                            <div class="fw-bold mt-1 text-muted">$8,725</div>
                          </td>
                          <td>
                            Status
                            <div class="fw-bold text-success  mt-1">87% </div>
                          </td>
                          <td>
                            Deadline
                            <div class="fw-bold mt-1 text-muted">11 Jun 2019</div>
                          </td>
                          <td>
                            <button type="button" class="btn btn-sm btn-dark border">edit actions</button>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="img-sm rounded-circle mb-md-0 me-2" src="../assets/images/faces/face33.png" alt="profile image">
                              <div>
                                <div> Company</div>
                                <div class="fw-bold mt-1 text-muted">Morgan </div>
                              </div>
                            </div>
                          </td>
                          <td>
                            Budget
                            <div class="fw-bold mt-1 text-muted">$5,220 </div>
                          </td>
                          <td>
                            Status
                            <div class="fw-bold text-success  mt-1">65% </div>
                          </td>
                          <td>
                            Deadline
                            <div class="fw-bold  mt-1 text-muted">26 Oct 2019</div>
                          </td>
                          <td>
                            <button type="button" class="btn btn-sm btn-dark border">edit actions</button>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="img-sm rounded-circle mb-md-0 me-2" src="../assets/images/faces/face34.png" alt="profile image">
                              <div>
                                <div> Company</div>
                                <div class="fw-bold  mt-1 text-muted">volkswagen</div>
                              </div>
