...
class CompanyNotificationService
{
    public const MODULES = [
        ...
        'jobwork_receive' => 'Jobwork Receives',
        ...
        'tree_cutting_office' => 'Tree Cutting Issue Office',
    ...
    public static function modulesForRoute(?string $routeName): array
    {
        ...
        return match (true) {
            ...
            str_starts_with($routeName, 'company.jobwork-receive.') => ['jobwork_receive'],
            ...
            str_starts_with($routeName, 'company.tree-cutting-office.') => ['tree_cutting_office'],
